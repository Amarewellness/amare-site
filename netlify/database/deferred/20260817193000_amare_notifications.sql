-- AMARÉ Notifications Phase N1 — durable inbox, booking/waitlist/reminder state.
-- Does not send push. Does not change auth, booking, or Stripe.
...
CREATE TABLE amare_class_reminders (
  ...
  CONSTRAINT amare_class_reminders_status_chk
    CHECK (status IN ('scheduled', 'cancelled', 'due', 'suppressed')),
